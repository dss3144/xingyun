...
local Window = OrionLib:MakeWindow({Name = "星云脚本", HidePremium = false, SaveConfig = true,IntroText = "星云脚本", ConfigFolder = "好闲"})
...
Tab:AddParagraph("感谢日月作者提供的UI和帮助")
Tab:AddParagraph("感谢MCX测试脚本")
Tab:AddParagraph("感谢syr测试脚本")
Tab:AddParagraph("感谢usu测试脚本")
Tab:AddButton({
